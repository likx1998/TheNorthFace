                ...
                class Switchover {
                    ...
                    init() {
                        this.list.on('click', (ev) => {
                            ...
                            this.box1.eq($(ev.target).index()).addClass('logo-l"').siblings().removeClass('logo-l"')
...
//     })
//     this.form.eq(curr).css({ left: this.form.width() }).animate({
//         left: 0
//     })
//     this.index = curr;
// }